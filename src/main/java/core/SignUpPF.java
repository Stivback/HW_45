...
public class SignUpPF {
	...
	public static void validate(WebDriver driver, String url) {
		...
		CommonPF.pageValidationPF("04. Element [Temperature (dynamic)]: ", CommonPF.pf_el_04);
		CommonPF.pageValidationPF("05. Element [Title]: ", CommonPF.pf_el_05);
		
		CommonPF.pageValidationPF("06. Element [Label]: ", CommonPF.pf_el_06);
		CommonPF.pageValidationPF("07. Element [First name]: ", CommonPF.pf_el_07);
		CommonPF.pageValidationPF("08. Element [Weather Icon]: ", CommonPF.pf_el_08);
		CommonPF.pageValidationPF("09. Element [Last name]: ", CommonPF.pf_el_09);
		...
		CommonPF.pageValidationPF("41. Phone Error (img)]: ", CommonPF.pf_el_41);
		}
}
